...
public abstract class Jzvd extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    public static final int VIDEO_IMAGE_DISPLAY_TYPE_RATIO = 4;//宽高比适配
    ...
    private boolean fullscreenTouchable;
    public boolean isLooping;
    protected View[] videoView = new View[2];
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.start) {
            ...
            if (jzDataSource == null || jzDataSource.urlsMap.isEmpty() || jzDataSource.getCurrentUrl() == null) {
                ToastUtil.show(R.string.no_url);
                return;
            }
    ...
    public void setFullScreenTouable(boolean touable) {
        this.fullscreenTouchable = touable;
        if (!fullscreenTouchable) {
...
//                        mDownY = y;
    ...
    public void startVideo() {
        ...
        try {
            ...
            this.mediaInterface.isLooping = isLooping;
        } catch (Exception e) {
            e.printStackTrace();
        }
        addTextureView();
    ...
    public void addTextureView() {
        ...
        textureView.VIDEO_IMAGE_DISPLAY_TYPE = VIDEO_IMAGE_DISPLAY_TYPE;
...
//                Log.v(TAG, "onProgressUpdate " + "[" + this.hashCode() + "] ");
    ...
    public void setVideoImageDisplayType(int type) {
        ...
        if (CURRENT_JZVD != null && CURRENT_JZVD.textureView != null) {
            CURRENT_JZVD.textureView.VIDEO_IMAGE_DISPLAY_TYPE = type;
