...
class VideoImageActivity : BaseActivity() {
    ...
    override fun getLayoutId(): Int = R.layout.activity_video_img_layout
    ...
    companion object {
        ...
        //启动Activity
        @JvmStatic
        fun start(context: Context?, detailSource: ArrayList<DetailImageBean>) {
            context?.startActivity(Intent(context, VideoImageActivity::class.java).apply {
