...
import kotlinx.android.synthetic.main.group_search_fragment.*
 ...
 * @author 银进
 */
class GroupSearchFragment : SimpleFrag() {
    ...
    private fun refreshData() {
        ...
        page = 1
        orderViewModel.doOrderListGroup(null, 0, row, page, null, keyword, null)
    }
    ...
    companion object {
        fun start(context: Context?) {
            val fragParam = SimpleFragAct.SimpleFragParam("",
                    GroupSearchFragment::class.java)
