...
public class ViewPagerIndicator extends HorizontalScrollView {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawRoundRect(mRect, DeviceUtil.dip2px(getContext(), 2f), DeviceUtil.dip2px(getContext(), 2f), mPaint);
        canvas.restore();
    ...
    private void initRectancle() {
        itemWidth = DeviceUtil.dip2px(getContext(), 14f);
        itemHeight = DeviceUtil.dip2px(getContext(), 4f);
        mRect = new RectF(0, 0, itemWidth, itemHeight);
    }
