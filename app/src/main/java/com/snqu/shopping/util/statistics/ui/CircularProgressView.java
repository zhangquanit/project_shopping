...
public class CircularProgressView extends View {
    ...
    private long mProgress;      // 圆环进度(0-100)
    private long max;
    ...
    public CircularProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mProgPaint.setStrokeWidth(typedArray.getDimension(R.styleable.CircularProgressView_progWidth, 5));
        mProgPaint.setColor(typedArray.getColor(R.styleable.CircularProgressView_progColor, Color.YELLOW));
...
//        canvas.drawArc(mRectF, 275, 360 * mProgress / max, false, mProgPaint);
        canvas.drawArc(mRectF, -90, ((float) mProgress / max) * 360, false, mProgPaint);
    }
